---
title: "Grip Strength and Longevity: What Your Handshake Reveals"
date: 2026-09-14
lastmod: 2026-09-14
...
Because it loads several systems at once, grip is a useful screening tool. It is not a diagnosis. A low number prompts a broader look at muscle mass, diet, activity, and metabolic markers. For that fuller picture, see [Body Composition vs. BMI](/blog/body-composition-vs-bmi/) and [How to Interpret Your Waist-to-Height Ratio](/blog/how-to-interpret-whtr/).
...
1. **Sit or stand consistently.** Most protocols use seated, elbow at 90 degrees, forearm supported, wrist neutral. Whatever you choose, repeat it the same way each time.
2. **Squeeze maximally for 3 to 5 seconds.** Build up smoothly rather than jerking.
3. **Do three attempts on each hand.** Rest 30 to 60 seconds between attempts on the same hand.
4. **Record the best of three for each hand.** Most research uses the highest value.
5. **Note which hand is dominant.** Dominant-hand values typically run slightly higher.
6. **Retest every 3 to 6 months** under the same conditions, ideally at the same time of day.
...
**Resistance training is the main lever.** Grip responds to direct training — heavy carries, deadlifts, rows, pull-ups, and dedicated gripper work — and to whole-body strength training. Muscle is use-it-or-lose-it tissue. The principles are covered in [Strength Training Is Metabolic Medicine](/blog/strength-training-for-metabolic-health/).

**Protein intake matters, especially after 60.** The standard RDA was set to prevent deficiency, not to preserve muscle with age. Older adults generally need more, distributed across meals. See [Protein After 60](/blog/protein-after-60/) and [How Much Protein Per Meal?](/blog/how-much-protein-per-meal/).
...
**Keep moving aerobically.** Cardiovascular fitness and strength are not competing goals. Zone 2 work supports the metabolic and mitochondrial side of the equation — see [Why Zone 2 Training Matters](/blog/why-zone-2-matters/) and [VO₂ Max and Longevity](/blog/cardiorespiratory-fitness-and-longevity/).

**Watch weight loss.** Losing weight without resistance training and adequate protein often means losing muscle. If you are deliberately losing fat, protect lean mass. As with any decision about your own health, discuss changes with your clinician, and see our [medical disclaimer](/medical-disclaimer/) for how this site handles medical information.
